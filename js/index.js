...
window.onload = function () {
    if (login_email, login_sandi === null) {
        ...
        <span class="hover:shadow-inner bg-slate-200 text-yellow-700 text-md font-mono px-1 shadow-lg py-0.5 rounded-md inline-block mb-3">Nombre de usuario : <span class="text-green-700">${valid_name}</span></span><br>
        <span class="hover:shadow-inner bg-slate-200 text-yellow-700 text-md font-mono px-1 shadow-lg py-0.5 rounded-md inline-block mb-3">Gmail : <span class="text-green-700">${valid_email}</span></span><br>
        <span class="hover:shadow-inner bg-slate-200 text-yellow-700 text-md font-mono px-1 shadow-lg py-0.5 rounded-md inline-block mb-3">Contraseña : <span class="text-green-700">${valid_sandi}</span></span><br>
        </center>
        `
    }
}
